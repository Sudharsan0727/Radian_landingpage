...
const PricingTable = () => {
    ...
    const pricingData = [
        {
            unitType: "2BHK+2T",
            area: "978 Sq.ft. to 1188 Sq.ft.",
        },
        {
            unitType: "3BHK+2T",
            area: "1132 Sq.ft. to 1177 Sq.ft.",
        },
        {
            unitType: "3BHK+3T",
            area: "1225 Sq.ft. to 1326 Sq.ft.",
        }
    ];
    ...
    return (
        <section id="pricing" className="section-padding bg-white relative">
            <div className="lux-container">
                ...
                <div className="max-w-[70rem] mx-auto animate-fade-up animate-delay-1 overflow-x-auto">
                    <div className="min-w-[800px] border border-gray-200">
                        {/* Table Header */}
                        <div className="grid grid-cols-3 bg-[#be9874] text-white">
                            <div className="py-4 text-center font-bold text-base md:text-lg border-r border-white/20">
                                Unit Type
                            </div>
                            <div className="py-4 text-center font-bold text-base md:text-lg border-r border-white/20">
                                Built up area
                            </div>
                            <div className="py-4 text-center font-bold text-base md:text-lg">
                                Unit Plan
                            </div>
                        </div>
                        ...
                        <div className="bg-white">
                            {pricingData.map((row, index) => (
                                ...
                                >
                                    <div className="py-5 text-center text-base md:text-lg font-medium text-gray-700 border-r border-gray-200">
                                        {row.unitType}
                                    </div>
                                    <div className="py-5 text-center text-base md:text-lg text-gray-600 border-r border-gray-200">
                                        {row.area}
                                    </div>
                                    <div className="py-5 flex justify-center">
                                        <button 
                                            onClick={() => setIsModalOpen(true)}
                                            className="flex items-center gap-2 bg-[#be9874] hover:bg-[#a67f59] text-white px-6 py-3 rounded text-sm md:text-base font-medium transition-colors"
                                        >
                                            {/* Lock Icon */}
                    ...
                    <div className="bg-white max-w-md w-full mx-4 rounded-xl shadow-2xl relative animate-modal-content">
                        ...
                        <div className="p-8">
                            <div className="text-center mb-6">
                                <h3 className="text-2xl font-heading text-luxury-black mb-2">Request Pricing Details</h3>
                            ...
                            <form className="space-y-4" onSubmit={(e) => {
                                ...
                                <button type="submit" className="w-full mt-4 bg-luxury-black text-white hover:bg-gold transition-colors duration-300 py-3 rounded font-bold uppercase tracking-widest text-xs">
                                    Get Pricing Access
                                </button>
